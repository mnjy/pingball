board name=Portals gravity=20.0 friction1=0.05 friction2=0.01
...
# define some portals
portal name=Portal1 x=1 y=1 otherBoard=MAMA otherPortal=Portal2
portal name=Portal2 x=0 y=15 otherPortal=Portal1
portal name=Portal3 x=15 y=15 otherPortal=Portal2
portal name=Portal4 x=3 y=0 otherBoard=portalToSendTo otherPortal=Portal2
portal name=Portal5 x=5 y=0 otherBoard=portalToSendTo otherPortal=Portal1
