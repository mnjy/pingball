board name=portalsEnterHere gravity=20.0 friction1=0.05 friction2=0.01
...
# define some portals
portal name=Portal2 x=0 y=15 otherPortal=doesntExist
portal name=Portal3 x=15 y=15 otherPortal=doesntExist
portal name=Portal4 x=3 y=0 otherBoard=doesntExist otherPortal=doesntExist
portal name=Portal5 x=5 y=0 otherBoard=doesntExist otherPortal=doesntExist
